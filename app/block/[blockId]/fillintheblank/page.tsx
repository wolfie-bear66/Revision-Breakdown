...
export default async function FillInTheBlankPage({ params }: PageProps) {
  ...
  if (questions.length === 0) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center gap-4 bg-background px-4 text-center">
        <p className="text-muted-foreground">No Fill in the Blank questions found for this block.</p>
        {subjectId && (
          <Link
